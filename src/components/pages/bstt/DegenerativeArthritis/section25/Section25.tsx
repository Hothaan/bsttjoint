...
export default function Section25() {
  const data_ = {
    bgPc: `/assets/components/pages/bstt/DegenerativeArthritis/section25/bg1_pc.png`,
    bgMo: `/assets/components/pages/bstt/DegenerativeArthritis/section25/bg1_mo.png`,
    sectionTitleSimple: {
      text: [
