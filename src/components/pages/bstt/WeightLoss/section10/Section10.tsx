...
export default function Section10() {
  const data_ = {
    ...
    cardData: [
      {
        img: `/assets/components/pages/bstt/WeightLoss/section10/card1_pc.png`,
        who: `40대 직장인`,
        desc: [
      ...
      {
        img: `/assets/components/pages/bstt/WeightLoss/section10/card2_pc.png`,
        who: `60대 주부`,
        desc: [
      ...
      {
        img: `/assets/components/pages/bstt/WeightLoss/section10/card3_pc.png`,
        who: `30대 운동선수`,
        desc: [
