...
export default function JointDisease() {
  const depth1 = "관절질환";
  const depth2 = "관절질환";
  const pageTitleDefault_ = {
    imgPc: `/assets/components/pages/bstt/JointDisease/pageTitleDefault/bg1_pc.png`,
    imgMo: `/assets/components/pages/bstt/JointDisease/pageTitleDefault/bg1_mo.png`,
    depth1: depth1,
    depth2: depth2,
