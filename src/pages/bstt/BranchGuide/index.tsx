...
import Section1 from "@/components/pages/bstt/BranchGuide/index/section1/Section1";

export default function BranchGuide() {
  const depth1 = "병원소개";
  const pageTitleDefault_ = {
    imgPc: `/assets/components/pages/bstt/BranchGuide/index/pageTitleDefault/bg1_pc.png`,
    imgMo: `/assets/components/pages/bstt/BranchGuide/index/pageTitleDefault/bg1_mo.png`,
    depth1: depth1,
    depth2: `지점안내`,
